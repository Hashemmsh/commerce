...
<img width="100%" src="{{ asset('siteassets/images/avater.jpg') }}" alt="">                alt="" class="w-full h-full object-cover">
        </div>
        ...
        <div
            ...
            <button type="button" class="w-full block bg-white hover:bg-gray-100 focus:bg-gray-100 text-gray-900 font-semibold rounded-lg px-4 py-3 border border-gray-300">
                ...
                <p class="text-sm text-gray-500 mt-12">&copy; {{ date('Y') }} {{ config('app.name') }}-All Rights
                    Reserved.</p>
            </div>
        </div>
