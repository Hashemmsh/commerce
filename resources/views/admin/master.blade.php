...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseCateory"
                    aria-expanded="true" aria-controls="collapseCateory">
                    <i class="fas fa-fw fa-tags"></i>
                    <span>{{ __('site.Categories') }}</span>
                </a>
                <div id="collapseCateory" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">

                        <a class="collapse-item" href="{{ route('admin.categories.index') }}">All Ctegories</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePromocodes" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">

                        <a class="collapse-item" href="adminassets/buttons.html">All Promocodes</a>
                        <a class="collapse-item" href="adminassets/cards.html">Add new</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTestimoials"
                    aria-expanded="true" aria-controls="collapseTestimoials">
                    <i class="fas fa-fw fa-comment-alt"></i>
                    <span>{{ __('site.Testimonials') }}</span>
                </a>
                <div id="collapseTestimoials" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 ">Languages
                            </a>
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                                ...
                                <!-- Counter - Alerts -->
                                <span class="badge badgedanger -badge-counter"></span>
                            </a>
                            <!-- Dropdown - Alerts -->
