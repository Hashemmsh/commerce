...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $content= json_encode(['en' => $request->content_en
        ,'ar'=>$request->content_ar],JSON_UNESCAPED_UNICODE
    ...
    public function edit(Product $product)
    {
        ...
        $categories= Category::select('id' , 'name')->where ('id', '!=',$product->id)->get();
    ...
    public function update(Request $request, Product $product)
    {
        ...
        ,'ar'=>$request->content_ar
          ...
          return redirect()->route('admin.products.index')->with('msg','Product update successfully')->with('type','info');
    }
    ...
    public function restore($id)
    {
        ...
        // return redirect()->route('admin.products.index')->with('msg','Product Restore successfully')->with('type','success');
